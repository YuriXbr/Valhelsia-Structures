...
/**
 * Castle Ruin Pieces
 * Valhelsia Structures - com.stal111.valhelsia_structures.world.structures.CastleRuinPieces
 *
...
public class CastleRuinPieces {
    ...
    public static void generate(ChunkGenerator<?> generator, TemplateManager templateManager, BlockPos position, List<StructurePiece> pieces, SharedSeedRandom random) {
        JigsawManager.func_214889_a(new ResourceLocation(ValhelsiaStructures.MOD_ID, "castle_ruins"), 7, CastleRuinPiece::new, generator, templateManager, position, pieces, random);
    }
