...
public class TowerRuinPieces {
    ...
    public static class TowerRuinPiece extends AbstractVillagePiece {
        public TowerRuinPiece(TemplateManager templateManager, JigsawPiece jigsawPiece, BlockPos position, int groundLevelDelta, Rotation rotation, MutableBoundingBox bounds) {
            super(ModStructurePieces.TOWER_RUIN, templateManager, jigsawPiece, position, groundLevelDelta, rotation, bounds);
        }
